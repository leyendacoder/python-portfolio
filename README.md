...
✅ text_cleaner.py → Clean messy text files (remove blank lines, extra spaces, double spaces)
...
✅ Full error handling (FileNotFound, Permission, Unicode errors)
✅ Safe file writing (never overwrite original files)
✅ User-friendly success/error messages with emojis
